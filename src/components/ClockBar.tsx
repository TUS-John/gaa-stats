  ...
  return (
    <div className="bg-white rounded-2xl shadow p-4 mb-3">
      ...
      <div className="mt-3 grid grid-cols-5 gap-2">
        {!running ? (
          <button
            className="py-2 rounded-xl bg-emerald-600 text-white"
            onClick={onStart}
          >
            Start
          </button>
          ...
          <button
            className="py-2 rounded-xl bg-amber-500 text-white"
            onClick={onPause}
          >
            Pause
          </button>
        ...
        <button
          className="py-2 rounded-xl bg-blue-600 text-white"
          onClick={onNextHalf}
        >
          Next Half
        </button>
        <button className="py-2 rounded-xl bg-gray-200" onClick={onResetTime}>
          Reset
        </button>
        <button
